...
public class StudentReport {
    ...
    private List<KnowledgePointStat> weakKnowledgePoints = new ArrayList<>();
    ...
    public Integer getCompletedSections() { return completedSections; }
    public void setCompletedSections(Integer completedSections) { this.completedSections = completedSections; }

    public Integer getUnfinishedSections() { return unfinishedSections; }
    public void setUnfinishedSections(Integer unfinishedSections) { this.unfinishedSections = unfinishedSections; }
    ...
    public Integer getWrongQuestionTotal() { return wrongQuestionTotal; }
    public void setWrongQuestionTotal(Integer wrongQuestionTotal) { this.wrongQuestionTotal = wrongQuestionTotal; }

    public Integer getMasteredWrongQuestions() { return masteredWrongQuestions; }
    public void setMasteredWrongQuestions(Integer masteredWrongQuestions) { this.masteredWrongQuestions = masteredWrongQuestions; }

    public Integer getUnmasteredWrongQuestions() { return unmasteredWrongQuestions; }
    public void setUnmasteredWrongQuestions(Integer unmasteredWrongQuestions) { this.unmasteredWrongQuestions = unmasteredWrongQuestions; }
    ...
    public void setWeakKnowledgePoints(List<KnowledgePointStat> weakKnowledgePoints) {
        this.weakKnowledgePoints = weakKnowledgePoints;
    }

    public String getMainWeakPoint() { return mainWeakPoint; }
    public void setMainWeakPoint(String mainWeakPoint) { this.mainWeakPoint = mainWeakPoint; }

    public String getLearningSuggestion() { return learningSuggestion; }
    public void setLearningSuggestion(String learningSuggestion) { this.learningSuggestion = learningSuggestion; }
}